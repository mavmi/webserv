...
SRCS_CORE			=	cgi.cpp managed_fds.cpp server.cpp socket_creator.cpp sockets.cpp utils/core_exception.cpp utils/core_utils.cpp
...
.PHONY: all clean fclean re test doNotForgetToDelete run_with_leaks run_tests_with_leaks
